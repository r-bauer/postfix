...
//-----------------------------------------------------------------------------
SSTACK *
CreateStack (int iStackSize, int iDataSize)
{
  SSTACK *pStk;
...
//-----------------------------------------------------------------------------
BOOL
PopData (SSTACK * pStk, void *pData)
{
  BYTE *pPos;
...
//-----------------------------------------------------------------------------
BOOL
PushData (SSTACK * pStk, void *pData)
{
  BYTE *pPos;
